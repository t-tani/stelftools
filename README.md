...
```bash
stelftools-ident -cfg ./signatures/<family>/<arch>/{name of toolchain}.json -target {path to target binary}
```
...
Example
```bash
$ stelftools-ident -cfg ./signatures/uclibc-pub/i586/ucli-pub-0.9.30.1_i586.json -target ./samples/built/main.i586
